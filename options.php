...
//////////////GENERAL SETTINGS START/////////////////////////
	...
	$options[] = array(
		'name' => __('Upload banner video', 'options_check'),
		'id' => 'banner-video',
		'type' => 'upload');
		
	$options[] = array(
		'name' => __('Banner Title', 'options_check'),
		'id' => 'banner-t',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('About Company Title', 'options_check'),
		'id' => 'i1',
		'type' => 'text');	
		
	$options[] = array(
		'name' => __('About Company Content', 'options_check'),
		'id' => 'ic1',
		'type' => 'editor');
